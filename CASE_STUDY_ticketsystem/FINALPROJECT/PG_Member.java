...
public class PG_Member {
	...
	public static void main(String[] args) {
		...
		for (;;) {
			System.out.println("1.admember 2.searchbyser 3.GetAllMembers 4.UpdateMember 5.DeleteMember 6.exit");
			...
			case 5:
				...
				int d=sc.nextInt();
				int m=pg.deletePG(d);
				System.out.println("Deleted "+m+"Row");
